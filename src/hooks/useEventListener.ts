import { BasicTarget, getTargetElement } from '@/lib/utils/domTarget'
import { useEffectWithTarget, useLatest } from '@/hooks'
...
function useEventListener(eventName: string | string[], handler: (event: Event) => void, options?: Options<Window>): void
